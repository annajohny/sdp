...
class NodeInfoArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NodeInfoArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.data[i] = NodeInfo.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NodeInfoArray(null);
    ...
    if (msg.data !== undefined) {
      ...
      for (let i = 0; i < resolved.data.length; ++i) {
        resolved.data[i] = NodeInfo.Resolve(msg.data[i]);
      }
    }
    else {
      resolved.data = []
