...
"""autogenerated by genpy from tug_resource_monitor/NodeInfoArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import tug_resource_monitor.msg
import std_msgs.msg

class NodeInfoArray(genpy.Message):
  _md5sum = "36980c6bc4abe5c7f2d787bbf2d3e856"
  _type = "tug_resource_monitor/NodeInfoArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','tug_resource_monitor/NodeInfo[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(NodeInfoArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tug_resource_monitor.msg.NodeInfo()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
