...
"""autogenerated by genpy from tug_reporter/SetStringRequest.msg. Do not edit."""
import sys
...
class SetStringRequest(genpy.Message):
  ...
  _type = "tug_reporter/SetStringRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from tug_reporter/SetStringResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SetStringResponse(genpy.Message):
  ...
  _type = "tug_reporter/SetStringResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
